...
exports.normalizeForFiltering = normalizeForFiltering;
exports.normalizedForms = normalizedForms;
 ...
 */
function normalizeForFiltering(text, map1 = 'i') {
    let s = text;
