...
const textNormalizer_1 = require("./textNormalizer");
 ...
 */
function containsRot13Injection(text) {
    const decoded = (0, textNormalizer_1.rot13)(text).toLowerCase();
